...
foreach(_expectedTarget mmdeploy_tensorrt_ops_obj spdlog mmdeploy_core mmdeploy_execution mmdeploy_opencv_utils mmdeploy_cpu_device mmdeploy_cuda_device mmdeploy_graph mmdeploy_directory_model mmdeploy_transform mmdeploy_cpu_transform_impl mmdeploy_cuda_transform_impl mmdeploy_transform_module mmdeploy_trt_net mmdeploy_net_module mmdeploy_mmcls mmdeploy_mmdet mmdeploy_mmseg mmdeploy_mmocr mmdeploy_mmocr_cuda_impl mmdeploy_mmedit mmdeploy_mmpose mmdeploy_mmrotate mmdeploy_common_obj mmdeploy_common mmdeploy_model_obj mmdeploy_model mmdeploy_executor_obj mmdeploy_executor mmdeploy_pipeline_obj mmdeploy_pipeline mmdeploy_classifier_obj mmdeploy_classifier mmdeploy_detector_obj mmdeploy_detector mmdeploy_segmentor_obj mmdeploy_segmentor mmdeploy_text_detector_obj mmdeploy_text_detector mmdeploy_text_recognizer_obj mmdeploy_text_recognizer mmdeploy_restorer_obj mmdeploy_restorer mmdeploy_pose_detector_obj mmdeploy_pose_detector mmdeploy_rotated_detector_obj mmdeploy_rotated_detector mmdeploy mmdeploy_cxx_api MMDeployStaticModules MMDeployDynamicModules MMDeployLibs)
...
# Create imported target mmdeploy_tensorrt_ops_obj
add_library(mmdeploy_tensorrt_ops_obj INTERFACE IMPORTED)

set_target_properties(mmdeploy_tensorrt_ops_obj PROPERTIES
  INTERFACE_LINK_LIBRARIES "nvinfer;nvinfer_plugin;cublas;cudnn"
)
...
set_target_properties(mmdeploy_core PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "spdlog;stdc++fs"
)
...
set_target_properties(mmdeploy_opencv_utils PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_core>;opencv_core;opencv_highgui;opencv_imgcodecs;opencv_imgproc"
)
...
# Create imported target mmdeploy_cuda_device
add_library(mmdeploy_cuda_device STATIC IMPORTED)

set_target_properties(mmdeploy_cuda_device PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_core>;/usr/local/cuda-11.1/lib64/libcudart.so;\$<LINK_ONLY:cuda>"
)
...
set_target_properties(mmdeploy_directory_model PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_core>;stdc++fs"
)
...
# Create imported target mmdeploy_cuda_transform_impl
add_library(mmdeploy_cuda_transform_impl STATIC IMPORTED)

set_target_properties(mmdeploy_cuda_transform_impl PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_core>;\$<LINK_ONLY:mmdeploy_transform>;\$<LINK_ONLY:pplcv_static>"
)
...
add_library(mmdeploy_trt_net STATIC IMPORTED)

set_target_properties(mmdeploy_trt_net PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_core>;\$<LINK_ONLY:mmdeploy_tensorrt_ops_obj>;nvinfer;nvinfer_plugin;cudnn"
)
...
set_target_properties(mmdeploy_mmocr PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_core>;\$<LINK_ONLY:mmdeploy_mmocr_cuda_impl>;\$<LINK_ONLY:mmdeploy_opencv_utils>;\$<LINK_ONLY:mmdeploy_transform>;\$<LINK_ONLY:mmdeploy_core>"
)

# Create imported target mmdeploy_mmocr_cuda_impl
add_library(mmdeploy_mmocr_cuda_impl INTERFACE IMPORTED)

set_target_properties(mmdeploy_mmocr_cuda_impl PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:mmdeploy_opencv_utils>;\$<LINK_ONLY:mmdeploy_core>;/usr/local/cuda-11.1/lib64/libcudart.so;\$<LINK_ONLY:cuda>"
)
...
set_target_properties(mmdeploy_cxx_api PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "mmdeploy_core"
)
...
set_target_properties(MMDeployStaticModules PROPERTIES
  INTERFACE_LINK_LIBRARIES "mmdeploy_execution;mmdeploy_cpu_device;mmdeploy_cuda_device;mmdeploy_graph;mmdeploy_directory_model;mmdeploy_transform;mmdeploy_cpu_transform_impl;mmdeploy_cuda_transform_impl;mmdeploy_transform_module;mmdeploy_trt_net;mmdeploy_net_module;mmdeploy_mmcls;mmdeploy_mmdet;mmdeploy_mmseg;mmdeploy_mmocr;mmdeploy_mmedit;mmdeploy_mmpose;mmdeploy_mmrotate"
)
...
set_target_properties(MMDeployLibs PROPERTIES
  INTERFACE_LINK_LIBRARIES "mmdeploy_core;mmdeploy_opencv_utils;mmdeploy_common;mmdeploy_model;mmdeploy_executor;mmdeploy_pipeline;mmdeploy_classifier;mmdeploy_detector;mmdeploy_segmentor;mmdeploy_text_detector;mmdeploy_text_recognizer;mmdeploy_restorer;mmdeploy_pose_detector;mmdeploy_rotated_detector"
)
